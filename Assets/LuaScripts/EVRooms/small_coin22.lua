...
local BILLBOARD_OBJECT_NAME = "SmallCoin (22)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (22)")

function OnSmallCoin22()
    -- Удаляем объект
