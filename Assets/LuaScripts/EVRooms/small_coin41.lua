...
local BILLBOARD_OBJECT_NAME = "SmallCoin (41)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (41)")

function OnSmallCoin41()
    -- Удаляем объект
