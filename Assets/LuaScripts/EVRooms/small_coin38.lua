...
local BILLBOARD_OBJECT_NAME = "SmallCoin (38)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (38)")

function OnSmallCoin38()
    -- Удаляем объект
