...
local BILLBOARD_OBJECT_NAME = "SmallCoin (67)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (67)")

function OnSmallCoin67()
    -- Удаляем объект
