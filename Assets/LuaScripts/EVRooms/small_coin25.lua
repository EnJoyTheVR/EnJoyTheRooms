...
local BILLBOARD_OBJECT_NAME = "SmallCoin (25)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (25)")

function OnSmallCoin25()
    -- Удаляем объект
