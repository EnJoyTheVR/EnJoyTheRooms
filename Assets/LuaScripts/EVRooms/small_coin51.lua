...
local BILLBOARD_OBJECT_NAME = "SmallCoin (51)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (51)")

function OnSmallCoin51()
    -- Удаляем объект
