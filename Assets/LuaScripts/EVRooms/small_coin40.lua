...
local BILLBOARD_OBJECT_NAME = "SmallCoin (40)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (40)")

function OnSmallCoin40()
    -- Удаляем объект
