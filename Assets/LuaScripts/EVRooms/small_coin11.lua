...
local BILLBOARD_OBJECT_NAME = "SmallCoin (11)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (11)")

function OnSmallCoin11()
    -- Удаляем объект
