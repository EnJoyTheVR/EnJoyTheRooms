...
local BILLBOARD_OBJECT_NAME = "SmallCoin (18)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (18)")

function OnSmallCoin18()
    -- Удаляем объект
