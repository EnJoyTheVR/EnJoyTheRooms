...
local BILLBOARD_OBJECT_NAME = "SmallCoin (61)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (61)")

function OnSmallCoin61()
    -- Удаляем объект
