...
local BILLBOARD_OBJECT_NAME = "SmallCoin (57)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (57)")

function OnSmallCoin57()
    -- Удаляем объект
