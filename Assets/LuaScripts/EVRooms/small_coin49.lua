...
local BILLBOARD_OBJECT_NAME = "SmallCoin (49)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (49)")

function OnSmallCoin49()
    -- Удаляем объект
