...
local BILLBOARD_OBJECT_NAME = "SmallCoin (52)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (52)")

function OnSmallCoin52()
    -- Удаляем объект
