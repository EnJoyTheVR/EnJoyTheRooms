...
local BILLBOARD_OBJECT_NAME = "SmallCoin (23)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (23)")

function OnSmallCoin23()
    -- Удаляем объект
