...
local BILLBOARD_OBJECT_NAME = "SmallCoin (1)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (1)")

function OnSmallCoin1()
    -- Удаляем объект
