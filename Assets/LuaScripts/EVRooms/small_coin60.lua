...
local BILLBOARD_OBJECT_NAME = "SmallCoin (60)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (60)")

function OnSmallCoin60)
    -- Удаляем объект
