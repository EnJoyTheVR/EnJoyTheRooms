...
local BILLBOARD_OBJECT_NAME = "SmallCoin (24)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (24)")

function OnSmallCoin24()
    -- Удаляем объект
