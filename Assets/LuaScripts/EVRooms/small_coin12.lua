...
local BILLBOARD_OBJECT_NAME = "SmallCoin (12)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (12)")

function OnSmallCoin12()
    -- Удаляем объект
