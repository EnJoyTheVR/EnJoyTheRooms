...
local BILLBOARD_OBJECT_NAME = "SmallCoin (13)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (13)")

function OnSmallCoin13()
    -- Удаляем объект
