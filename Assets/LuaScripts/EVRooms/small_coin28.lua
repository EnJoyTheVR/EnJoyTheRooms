...
local BILLBOARD_OBJECT_NAME = "SmallCoin (28)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (28)")

function OnSmallCoin28()
    -- Удаляем объект
