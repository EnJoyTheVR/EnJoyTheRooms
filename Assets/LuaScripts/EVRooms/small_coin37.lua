...
local BILLBOARD_OBJECT_NAME = "SmallCoin (37)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (37)")

function OnSmallCoin37()
    -- Удаляем объект
