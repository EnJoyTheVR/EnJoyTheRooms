...
local BILLBOARD_OBJECT_NAME = "SmallCoin (45)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (45)")

function OnSmallCoin45()
    -- Удаляем объект
