...
local BILLBOARD_OBJECT_NAME = "SmallCoin (9)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (9)")

function OnSmallCoin9()
    -- Удаляем объект
