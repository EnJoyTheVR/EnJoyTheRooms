...
local BILLBOARD_OBJECT_NAME = "SmallCoin (19)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (19)")

function OnSmallCoin19()
    -- Удаляем объект
