...
local BILLBOARD_OBJECT_NAME = "SmallCoin (58)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (58)")

function OnSmallCoin58()
    -- Удаляем объект
