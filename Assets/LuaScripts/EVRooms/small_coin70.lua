...
local BILLBOARD_OBJECT_NAME = "SmallCoin (70)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (70)")

function OnSmallCoin70()
    -- Удаляем объект
