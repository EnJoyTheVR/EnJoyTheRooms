...
local BILLBOARD_OBJECT_NAME = "SmallCoin (62)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (62)")

function OnSmallCoin62()
    -- Удаляем объект
