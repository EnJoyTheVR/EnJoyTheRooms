...
local BILLBOARD_OBJECT_NAME = "SmallCoin (64)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (64)")

function OnSmallCoin64()
    -- Удаляем объект
