...
local BILLBOARD_OBJECT_NAME = "SmallCoin (27)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (27)")

function OnSmallCoin27()
    -- Удаляем объект
