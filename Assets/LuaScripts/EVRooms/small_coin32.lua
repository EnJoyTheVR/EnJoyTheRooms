...
local BILLBOARD_OBJECT_NAME = "SmallCoin (32)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (32)")

function OnSmallCoin32()
    -- Удаляем объект
