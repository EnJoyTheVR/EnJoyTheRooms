...
local BILLBOARD_OBJECT_NAME = "SmallCoin (5)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (5)")

function OnSmallCoin5()
    -- Удаляем объект
