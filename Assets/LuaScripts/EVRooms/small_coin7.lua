...
local BILLBOARD_OBJECT_NAME = "SmallCoin (7)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (7)")

function OnSmallCoin7()
    -- Удаляем объект
