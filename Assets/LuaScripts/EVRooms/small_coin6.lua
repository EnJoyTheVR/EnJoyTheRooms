...
local BILLBOARD_OBJECT_NAME = "SmallCoin (6)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (6)")

function OnSmallCoin6()
    -- Удаляем объект
