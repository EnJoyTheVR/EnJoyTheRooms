...
local BILLBOARD_OBJECT_NAME = "SmallCoin (17)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (17)")

function OnSmallCoin17()
    -- Удаляем объект
