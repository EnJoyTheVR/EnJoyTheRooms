...
local BILLBOARD_OBJECT_NAME = "SmallCoin (21)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (21)")

function OnSmallCoin21()
    -- Удаляем объект
