...
local BILLBOARD_OBJECT_NAME = "SmallCoin (56)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (56)")

function OnSmallCoin56()
    -- Удаляем объект
