...
local BILLBOARD_OBJECT_NAME = "SmallCoin (30)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (30)")

function OnSmallCoin30()
    -- Удаляем объект
