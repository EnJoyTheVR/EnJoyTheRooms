...
local BILLBOARD_OBJECT_NAME = "SmallCoin (35)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (35)")

function OnSmallCoin35()
    -- Удаляем объект
