...
local BILLBOARD_OBJECT_NAME = "SmallCoin (36)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (36)")

function OnSmallCoin36()
    -- Удаляем объект
