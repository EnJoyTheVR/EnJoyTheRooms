...
local BILLBOARD_OBJECT_NAME = "SmallCoin (26)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (26)")

function OnSmallCoin26()
    -- Удаляем объект
