...
local BILLBOARD_OBJECT_NAME = "SmallCoin (34)"  -- <<< ЗАМЕНИТЕ на имя вашего объекта
...
local objectToDestroy = CS.UnityEngine.GameObject.Find("SmallCoin (34)")

function OnSmallCoin34()
    -- Удаляем объект
